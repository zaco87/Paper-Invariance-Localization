function [chirps,chirps_loc,is_successfull,dls] = chirps_and_locationQ1(file_location,angle_n_of_object,planned_distance,planned_angle,planned_side)
...
pause(0.01); %20
%%%% END OF 11111
%%%% now recorded_data, recorded_data_k(i) is the signal after the cut %%%%%%%%%%%%
%%%% #####################################################
%%%% i need to use recorded_data_k(i) only from now on ###
%%%% the original indexes are not important for now    ###
%%%% #####################################################

%%%% now im sending the fifth's data to be recognized again for R & D
[cut_signal1,rt1,i_s1,dls1]=find_t_RQ1(recorded_data_k{1},input_rate, FLV1,planned_distance,planned_angle,planned_side);  % if there are 10 values=1,3,5,7,9 are D, and 2,4,6,8,10 are R
[cut_signal2,rt2,i_s2,dls2]=find_t_RQ1(recorded_data_k{2},input_rate, FLV1,planned_distance,planned_angle,planned_side);  % if there are 10 values=1,3,5,7,9 are D, and 2,4,6,8,10 are R
[cut_signal3,rt3,i_s3,dls3]=find_t_RQ1(recorded_data_k{3},input_rate, FLV1,planned_distance,planned_angle,planned_side);  % if there are 10 values=1,3,5,7,9 are D, and 2,4,6,8,10 are R
[cut_signal4,rt4,i_s4,dls4]=find_t_RQ1(recorded_data_k{4},input_rate, FLV1,planned_distance,planned_angle,planned_side);  % if there are 10 values=1,3,5,7,9 are D, and 2,4,6,8,10 are R
[cut_signal5,rt5,i_s5,dls5]=find_t_RQ1(recorded_data_k{5},input_rate, FLV1,planned_distance,planned_angle,planned_side);  % if there are 10 values=1,3,5,7,9 are D, and 2,4,6,8,10 are R
