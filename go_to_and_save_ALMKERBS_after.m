function [FreqsD FreqsR] = go_to_and_save_ALMKERBS_after(DQ,RQ)
% FreqsD(/R) contains the values of R (/D) at all the freqs of f
% FreqsD(A,L,M,K,E,R,B,S) 
%%%%% new part - spectrograms
%$%$%$% i just copied stuff. still need to work on the structure
